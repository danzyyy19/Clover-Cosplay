...
export function AdminSidebar({ children }: AdminSidebarProps) {
    ...
    const menuItems = [
        ...
        { icon: ShoppingCart, label: "Orders", href: `/${locale}/admin/orders` },
        { icon: CreditCard, label: "Payments", href: `/${locale}/admin/payments` },
        { icon: Users, label: "Customers", href: `/${locale}/admin/customers` },
        { icon: BarChart3, label: "Reports", href: `/${locale}/admin/reports` },
