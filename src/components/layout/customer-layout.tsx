...
export function CustomerLayout({ children, pageTitle = "Dashboard" }: CustomerLayoutProps) {
    ...
    const menuItems = [
        ...
        { icon: ShoppingBag, labelEn: "Products", labelTh: "สินค้า", href: `/${locale}/customer/products` },
        { icon: Calendar, labelEn: "My Bookings", labelTh: "การจอง", href: `/${locale}/customer/bookings` },
        { icon: CreditCard, labelEn: "Payments", labelTh: "ชำระเงิน", href: `/${locale}/customer/payments` },
    ...
    const isActive = (href: string) => {
        ...
        if (hrefWithoutLocale === '/customer' || hrefWithoutLocale === '') {
            return pathnameWithoutLocale === '/customer' || pathnameWithoutLocale === '';
        }
                ...
                <div style={{ paddingBottom: "16px", marginBottom: "16px", borderBottom: "1px solid var(--border-color)" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            <p style={{ fontSize: "11px", color: "var(--text-secondary)", margin: "2px 0 0 0", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                                {session?.user?.email}
                            </p>
                        </div>
                    </div>
