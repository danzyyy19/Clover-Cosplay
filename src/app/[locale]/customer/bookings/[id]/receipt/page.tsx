                ...
                <div style={{ width: "100%", maxWidth: "380px" }}>
                    ...
                    >
                        ...
                        <div style={{ textAlign: "center", marginBottom: "20px" }}>
                            ...
                            <p style={{ fontSize: "10px", color: "#666" }}>Premium Costume Rental Service</p>
                        ...
                        <div style={{ marginBottom: "16px", fontSize: "11px" }}>
                            <span style={{ display: "block", fontWeight: "bold", marginBottom: "2px" }}>CUSTOMER:</span>
                        ...
                        <div style={{ marginBottom: "16px" }}>
                            ...
                            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "4px", fontSize: "11px" }}>
                                <div style={{ display: "flex", flexDirection: "column" }}>
                                    <span style={{ fontWeight: "bold" }}>{booking.product.nameEn}</span>
                                    <span style={{ fontSize: "10px", color: "#444" }}>Size: {booking.product.size}</span>
                                    <span style={{ fontSize: "10px", color: "#444" }}>
                                        {format(new Date(booking.startDate), "dd/MM")} - {format(new Date(booking.endDate), "dd/MM")} ({totalDays}d)
                                    </span>
                                </div>
                        ...
                        <div style={{ marginBottom: "16px", fontSize: "10px", color: "#444", border: "1px solid #000", padding: "8px" }}>
                            <p style={{ fontWeight: "bold", marginBottom: "4px" }}>IMPORTANT RULES:</p>
                            <ul style={{ paddingLeft: "12px", margin: 0 }}>
                                <li>Late return fee: 500 THB / day</li>
                                <li>Do not wash the costume</li>
                                <li>Damage fee depends on condition</li>
                            </ul>
                        </div>
                        ...
                        <div style={{ textAlign: "center", marginTop: "24px", fontSize: "10px", color: "#444" }}>
                            ...
                            <p style={{ marginTop: "4px" }}>Please check items upon receiving</p>
                        </div>
