...
export default async function AdminReportsPage({
    ...
    const stats = [
        { icon: TrendingUp, label: "Total Revenue", value: `฿${(totalRevenue._sum.totalPrice || 0).toLocaleString()}`, color: "#7FFFD4" },
        { icon: ShoppingCart, label: "Total Bookings", value: totalBookings, color: "#9370DB" },
        { icon: Package, label: "Total Products", value: totalProducts, color: "#DDA0DD" },
        { icon: Users, label: "Total Customers", value: totalCustomers, color: "#FFB6C1" },
    ];
        ...
        <AdminLayout pageTitle="Reports">
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                ...
                <div style={{
                    ...
                    <h3 style={{ fontSize: "14px", fontWeight: "600", color: "var(--text-primary)", marginBottom: "16px" }}>Activity</h3>
                    <div style={{ display: "flex", flexDirection: "column", gap: "12px", justifyContent: "center", height: "100%", alignItems: "center", color: "var(--text-secondary)" }}>
                        <p style={{ fontSize: "13px" }}>Detailed analytics coming soon...</p>
                    </div>
                </div>
                ...
                <div style={{
                    ...
                    <h3 style={{ fontSize: "14px", fontWeight: "600", color: "var(--text-primary)", marginBottom: "16px" }}>Booking Status</h3>
                    <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                        {[
                            { label: "Pending", value: statsPending, color: "#F0E68C" },
                            { label: "Active", value: statsActive, color: "#7FFFD4" },
                            { label: "Completed", value: statsCompleted, color: "#9370DB" },
                            { label: "Cancelled", value: statsCancelled, color: "#FFB6C1" },
                        ].map((item) => (
