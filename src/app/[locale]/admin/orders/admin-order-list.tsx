...
import { Eye, Check, X, Clock, Calendar, User, Package } from "lucide-react";
                ...
                {["All", "PENDING", "CONFIRMED", "ACTIVE", "COMPLETED", "CANCELLED"].map((tab) => (
                    <button
                        ...
                        style={{
                            padding: "8px 16px",
                            borderRadius: "20px",
                            border: filter === tab ? "1px solid #9370DB" : "1px solid var(--border-color)",
                            backgroundColor: filter === tab ? "rgba(147, 112, 219, 0.1)" : "var(--bg-card)",
                            color: filter === tab ? "#9370DB" : "var(--text-secondary)",
                            cursor: "pointer",
                            fontSize: "13px",
                            fontWeight: "500",
                            whiteSpace: "nowrap",
                                        ...
                                        <tr key={order.id}>
                                            ...
                                            <td>
                                                <div style={{ display: "flex", flexDirection: "column", fontSize: "13px" }}>
                                                    ...
                                                    <span style={{ color: "var(--text-secondary)" }}>to {new Date(order.endDate).toLocaleDateString()}</span>
                                                </div>
                                            </td>
